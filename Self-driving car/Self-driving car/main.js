...
/*
    move this inside animate to draw a clean new canvas each time or else the car leaves a trail of its past positions 
...
const N = 100;
const cars = generateCars(N);//"KEYS"); //(x-pos, y-pos, width, height)
let bestCar = cars[0];
...
function animate(time){
    ...
    requestAnimationFrame(animate); // calls animate function several times per second to give an illusion of motion
}
